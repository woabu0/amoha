...
export const About = () => {
  return (
    <section className="p-5 -mt-24 mx-10 rounded-xl bg-[#F9FBFF] shadow-sm">
      <motion.div {...fadeIn("up", 0)}>
        <h1 className="text-2xl text-center lg:text-4xl xl:text-[50px] text-black font-semibold">
          What we do?
        </h1>
        <p className="text-center mt-3 w-full lg:w-3/4 m-auto text-sm">
